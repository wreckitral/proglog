...
// reads the record stored at the gicen offset
...
// removes the log and the creates a new log to replace it
...
// remove old segments whose data we have processed by then
